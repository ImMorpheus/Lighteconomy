...
public class Reference2ObjectOpenHashMap<K, V> extends AbstractReference2ObjectMap<K, V>
    ...
    protected final V removeEntry(final int pos) {
    ...
    protected final V removeNullEntry() {
    ...
    @SuppressWarnings("unchecked")
    protected final int find(final K k) {
        if (((k) == (null)))
    ...
    protected final void insert(final int pos, final K k, final V v) {
        if (pos == n)
